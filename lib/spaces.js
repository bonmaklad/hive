export const spaces = [
    ...
    },
    {
        ...
        headerImage: '/meeting1.jpg',
        capacity: 'Up to 6 people',
        pricing: { halfDay: 80, fullDay: 150 },
        layouts: [
            { label: 'Meeting', capacity: 'Up to 6 people' }
        ],
        highlights: ['Whiteboard', 'Quiet + private', 'Great for short sessions'],
        bestFor: ['1:1s', 'Interviews', 'Client check-ins', 'Planning'],
        images: [
            '/meeting1.jpg'
        ]
    },
    ...
    },
    {
        ...
        headerImage: '/manukau1.jpg',
        capacity: 'Up to 10 people',
        pricing: { halfDay: 100, fullDay: 180 },
        layouts: [
            { label: 'Boardroom', capacity: '8–10 people' },
            { label: 'Workshop', capacity: 'Up to 10 people' }
        ],
        highlights: ['TV', 'Whiteboard', 'Easy setup'],
        bestFor: ['Workshops', 'Team sessions', 'Small training', 'Meetings'],
        images: [
            '/manukau1.jpg',
            '/manuka2.jpg'
        ]
